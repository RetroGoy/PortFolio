...
kit-bashing et filmée sous tous les angles. Tout se joue dans l'ambiance : lumière, brume,
silhouettes — du mystique posé sur de l'industriel.`,
    images: [],
    moodboard: {
      note: "Pas mes images : les références de départ.",
      items: [
        {
